...
func (k *Client) extractServiceAccountSecretInfo(ctx context.Context, serviceAccount *v1.ServiceAccount) (ca, token []byte, err error) {
...
func (k *Client) generateKubeconfig(ctx context.Context, serviceAccount *v1.ServiceAccount) ([]byte, error) {
