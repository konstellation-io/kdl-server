...
func NewInteractor(logger logging.Logger, repo Repository, sshGenerator sshhelper.SSHKeyGenerator, c clock.Clock) *Interactor {
	return &Interactor{logger: logger, repo: repo, sshGenerator: sshGenerator, clock: c}
}
