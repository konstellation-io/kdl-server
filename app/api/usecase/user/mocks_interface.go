...
// Create mocks base method
func (m *MockUseCase) Create(ctx context.Context, email string, accessLevel entity.AccessLevel) (entity.User, error) {
	m.ctrl.T.Helper()
...
// Create indicates an expected call of Create
func (mr *MockUseCaseMockRecorder) Create(ctx, email, accessLevel interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockUseCase)(nil).Create), ctx, email, accessLevel)
}
