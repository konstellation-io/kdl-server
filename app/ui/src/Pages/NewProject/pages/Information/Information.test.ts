...
describe('InformationUtils', () => {
  describe('validateProjectName', () => {
    it.each`
      ...
      ${loremIpsum}                                    | ${[]}           | ${true}
    `('should return $expected when projectName is $name', ({ name, names, expected }) => {
      // Arrange.
      // Act.
  ...
  describe('validateProjectDescription', () => {
    it.each`
      ...
      ${loremIpsum}                                           | ${true}
    `('should return $expected when description is $description', ({ description, expected }) => {
      // Arrange.
      // Act.
  ...
  describe('validateProjectId', function () {
    it.each`
      ...
      ${'foo-bar-baz'}                       | ${[]}          | ${true}
    `('should return $expected when the project id is $projectId', ({ id, ids, expected }) => {
      // Arrange.
      // Act.
