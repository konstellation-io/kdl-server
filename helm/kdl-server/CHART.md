...
| mongodb.affinity | object | `{}` | Assign custom affinity rules. Ref: https://kubernetes.io/docs/concepts/configuration/assign-pod-node/ |
| mongodb.auth.adminPassword | string | `"123456"` | admin password |
| mongodb.auth.adminUser | string | `"admin"` | admin username |
| mongodb.host | string | `"kdl-mongo-0"` | MongoDB hostname. Used by backup to connect the MongoDB instance |
