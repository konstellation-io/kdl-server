...
def download_arxiv_json(origin: str, dest_path: str):
    print(f"Downloading arxiv json to: {dest_path}/arxiv-metadata-oai-snapshot.json")
    client = storage.Client.create_anonymous_client()
    dest = Path(dest_path, "arxiv-metadata-oai-snapshot.json")
...
if __name__ == "__main__":
    ...
    download_arxiv_json(ARXIV_JSON, DOWNLOAD_PATH)
