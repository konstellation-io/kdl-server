...
class GraphItem(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"abstract",b"abstract",u"authors",b"authors",u"category",b"category",u"date",b"date",u"external_id",b"external_id",u"framework",b"framework",u"id",b"id",u"score",b"score",u"title",b"title",u"url",b"url"]) -> None: ...
